    ...
    <div className="bg-card rounded-3xl p-5 md:p-6 shadow-sm border border-border/50 transition-colors duration-300 h-full flex flex-col">
      <div className="flex items-center gap-3 mb-5 md:mb-6">
        <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#2B5BBA]/10 rounded-xl flex items-center justify-center shrink-0">
          <Settings className="w-5 h-5 sm:w-6 sm:h-6 text-[#2B5BBA] dark:text-[#5588ff]" />
        </div>
      ...
      <div className="space-y-5 md:space-y-6 flex-1">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
          <div>
            ...
            <input
              ...
              placeholder="0,00"
              className="w-full px-4 py-3 sm:py-3.5 bg-muted/50 border border-transparent rounded-xl text-foreground focus:outline-none focus:ring-2 focus:ring-[#2B5BBA] transition-all font-bold text-sm sm:text-base"
            />
          </div>
          <div>
            <label className="block text-xs sm:text-sm font-medium text-foreground mb-1.5 sm:mb-2">
          ...
          {rateType === "cdi" ? (
            <div className="animate-in fade-in slide-in-from-top-2 duration-300">
              <div className="flex items-center justify-between mb-2 sm:mb-3">
                ...
                <span className="text-base sm:text-lg font-bold text-[#2B5BBA] dark:text-[#5588ff]">
                  {cdiPercentage}%
                </span>
              </div>
              <input
            ...
            <div className="animate-in fade-in slide-in-from-top-2 duration-300">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 sm:py-3.5 bg-muted/50 border border-transparent rounded-xl text-foreground focus:outline-none focus:ring-2 focus:ring-[#2B5BBA] transition-all font-bold text-sm sm:text-base"
                />
                <span className="absolute right-4 top-1/2 -translate-y-1/2 font-bold text-sm sm:text-base text-muted-foreground">
                  % a.a.
                </span>
              </div>
            </div>
          ) : (
            <div className="h-full p-3 sm:p-4 bg-muted/30 border border-border/50 rounded-2xl flex items-center justify-center animate-in fade-in duration-300">
        ...
        <div className="flex items-start sm:items-center gap-3 p-3 sm:p-4 bg-muted/30 border border-border/50 rounded-2xl">
          <input
            type="checkbox"
            id="considerTax"
            checked={considerTax}
            onChange={(e) => setConsiderTax(e.target.checked)}
            className="w-4 h-4 sm:w-5 sm:h-5 mt-0.5 sm:mt-0 accent-[#2B5BBA] cursor-pointer rounded shrink-0"
          />
      ...
      <button
        ...
        className="w-full mt-5 sm:mt-6 inline-flex items-center justify-center gap-2 bg-[#2B5BBA] text-white px-5 sm:px-6 py-3.5 sm:py-4 rounded-xl hover:opacity-90 transition-all font-bold text-base sm:text-lg shadow-lg shadow-blue-500/20 disabled:opacity-70 disabled:cursor-not-allowed"
      >
        {isSimulating ? (
          <>
