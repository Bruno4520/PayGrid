            ...
            <div className="lg:col-span-2">
              <div className="bg-card rounded-3xl p-8 shadow-sm border border-border/50 transition-colors">
                <div className="flex flex-col items-center mb-8">
                  <div className="w-24 h-24 rounded-full bg-gradient-to-br from-[#2B5BBA] to-[#4C7FEE] flex items-center justify-center text-white text-3xl font-bold shadow-lg uppercase">
                ...
                <form className="space-y-6" onSubmit={handleUpdateProfile}>
                  ...
                  <div className="pt-4 mt-8 border-t border-border/50">
                    <button
                      ...
                      className="w-full sm:w-auto px-8 py-3.5 bg-[#2B5BBA] text-white rounded-xl hover:opacity-90 transition-all font-bold shadow-lg shadow-blue-500/20 disabled:opacity-50 flex items-center justify-center gap-2"
                    >
                      {isSaving ? (
              ...
              <div className="bg-card rounded-3xl p-6 shadow-sm border border-red-500/20 transition-colors">
                ...
                <div className="space-y-3">
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 p-3.5 bg-red-500/10 hover:bg-red-500/20 text-red-600 dark:text-red-400 rounded-xl transition-colors font-bold text-sm"
                  >
                    <LogOut size={18} />
                    Sair da Conta
                  </button>
                  ...
                  <button
                    ...
                    disabled={isDeleting}
                    className="w-full flex items-center justify-center gap-2 p-3.5 text-muted-foreground hover:text-red-600 hover:bg-red-500/10 rounded-xl transition-colors font-bold text-sm mt-2 disabled:opacity-50"
                  >
                    {isDeleting ? (
                      <Loader2 size={18} className="animate-spin" />
                    ) : (
